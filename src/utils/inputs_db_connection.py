import psycopg2
from utils.config import JOBINDSATS_POSTGRES_DB_HOST, JOBINDSATS_POSTGRES_DB_USER, JOBINDSATS_POSTGRES_DB_PASS, JOBINDSATS_POSTGRES_DB_DATABASE, JOBINDSATS_POSTGRES_DB_PORT
