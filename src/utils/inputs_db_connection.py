...
from utils.config import (
    JOBINDSATS_POSTGRES_DB_HOST,
    JOBINDSATS_POSTGRES_DB_USER,
    JOBINDSATS_POSTGRES_DB_PASS,
    JOBINDSATS_POSTGRES_DB_DATABASE,
...
class InputsDBConnection:
    def __init__(self):
        ...
        self.port = int(JOBINDSATS_POSTGRES_DB_PORT)
