...
def show_forside():
    st.title("Jobindsats-dashboard")
    st.markdown("## Velkommen til Randers Kommunes jobindsats-dashboardet")
    st.markdown("Data trækkes fra [api.jobindsats.dk](https://api.jobindsats.dk/) og opdateres ugentlig. Formålet med dashboardet er at give et overblik over jobindsatsen i Randers Kommune og gøre det nemt for medarbejdere, ledere og beslutningstagere at få indsigt i relevante data.")
